...
cfg.outputs.hourly_csv = fullfile(ProjectRoot,'Results','single_config_v1_hourly.csv');
cfg.outputs.summary_csv = fullfile(ProjectRoot,'Results','single_config_v1_summary.csv');
cfg.outputs.summary_mat = fullfile(ProjectRoot,'Results','single_config_v1_summary.mat');
cfg.outputs.report_txt = fullfile(ProjectRoot,'Results','single_config_v1_report.txt');
