...
%% Ortak değişkenlere erişim ve giriş kontrolleri
...
%% Şarj ve deşarj kontrol komutlarının hesaplanması
...
%% Tank durumuna ait gerçek zaman etiketinin belirlenmesi
...
%% Type840 çıkışlarının ayrı değişkenlere aktarılması
...
%% Yeni tank durumunun sonuç matrisine kaydedilmesi
...
%% Periyodik ara yedekleme işlemi
