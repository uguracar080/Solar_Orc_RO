...
%% Ortak değişkenlere erişim ve sonlandırma kontrolü
...
%% Son zaman için kontrol komutlarının oluşturulması
...
%% Son tank durumunun gerekirse sonuçlara eklenmesi
...
%% Sonuç tablosunun oluşturulması ve dosyalara kaydedilmesi
...
%% Tank orta nokta sıcaklığı grafiğinin oluşturulması
...
%% PCM enerji içeriği grafiğinin oluşturulması
...
%% Ara yedek dosyasının temizlenmesi
...
%% Tamamlanma bilgilerinin MATLAB komut penceresine yazdırılması
