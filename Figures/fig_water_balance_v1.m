...
subplot(2,1,1);
hold on;
plot(Hourly.source_hour,Hourly.Qp_total_m3h,'-o','LineWidth',1.3,'MarkerSize',5);
plot(Hourly.source_hour,Hourly.CT_makeup_m3h,'-s','LineWidth',1.1,'MarkerSize',5);
plot(Hourly.source_hour,net_m3h,'-^','LineWidth',1.3,'MarkerSize',5);
grid on;
xlabel('Source hour');
...
subplot(2,1,2);
hold on;
plot(Hourly.source_hour,cumProduct,'-o','LineWidth',1.3,'MarkerSize',5);
plot(Hourly.source_hour,cumMakeup,'-s','LineWidth',1.1,'MarkerSize',5);
plot(Hourly.source_hour,cumNet,'-^','LineWidth',1.3,'MarkerSize',5);
grid on;
xlabel('Source hour');
