function Results = run_RO_ANN_train_v1_9_1(final_mat_file)
% RO ANN v1.9.1
% Trains:
...
fprintf('\n============================================================\n');
fprintf('RO ANN v1.9.1 - MODEL TRAINING\n');
fprintf('============================================================\n');
...
%% SAVE
writetable(SearchClassifier, 'RO_ANN_classifier_architecture_search_v1_9_1.csv');
writetable(SearchRegression, 'RO_ANN_regression_architecture_search_v1_9_1.csv');
writetable(SearchCpActive, 'RO_ANN_Cp_active_architecture_search_v1_9_1.csv');
writetable(SearchCpMargin, 'RO_ANN_Cp_margin_architecture_search_v1_9_1.csv');
writetable(RegressionSummary, 'RO_ANN_regression_test_metrics_v1_9_1.csv');
writetable(ClassifierSummary, 'RO_ANN_classifier_test_metrics_v1_9_1.csv');
writetable(Pred, 'RO_ANN_blind_test_predictions_v1_9_1.csv');
...
save('RO_ANN_models_v1_9_1.mat', 'Models', 'Results', 'cfg', '-v7.3');

fprintf('\n============================================================\n');
fprintf('ANN TRAINING COMPLETE\n');
fprintf('Models      : RO_ANN_models_v1_9_1.mat\n');
fprintf('Blind preds : RO_ANN_blind_test_predictions_v1_9_1.csv\n');
fprintf('Reg metrics : RO_ANN_regression_test_metrics_v1_9_1.csv\n');
fprintf('Cls metrics : RO_ANN_classifier_test_metrics_v1_9_1.csv\n');
fprintf('============================================================\n\n');
end
...
cfg.invalid_specificity_target = 0.97;
